...
<body class="bg-gray-200 ">
  ...
  <!-- Modal -->
  <div id="exampleModal" class="fixed inset-0 overflow-y-auto md:hidden hidden z-50">
          ...
          <div class="sm:flex sm:items-start">
            <div class="mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-blue-100 sm:mx-0 sm:h-10 sm:w-10">
              <svg class="h-6 w-6 text-blue-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 2m-6 2h12a2 2 0 002-2V8a2 2 0 00-2-2H6a2 2 0 00-2 2v8a2 2 0 002 2" />
              </svg>
            </div>
            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
              ...
              <div class="mt-2">
                ...
                <input type="text" id="nombre" name="nombre" class="w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 sm:text-sm" />
              </div>
              <div class="mt-2">
                <label for="telefono" class="block text-sm font-medium text-gray-700">Teléfono:</label>
                <input type="number" id="telefono" name="telefono" class="w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 sm:text-sm" />
              </div>
              <div class="mt-2">
                <label for="cargo" class="block text-sm font-medium text-gray-700">Cargo:</label>
                <input type="text" id="cargo" name="cargo" class="w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 sm:text-sm" />
              </div>
            </div>
          </div>
        </div>
        <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
          <button id="guardarCambiosBtn" type="button" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-green-600 text-base font-medium text-white hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 sm:ml-3 sm:w-auto sm:text-sm">
            Guardar Cambios
          </button>
    ...
    function agregarDatosATabla(data) {
      ...
      data.forEach((item) => {
        ...
        btnActualizar.click(function() {
          $("#exampleModal").removeClass("md:hidden");
          ...
          $("#guardarCambiosBtn")
            ...
            .on("click", function() {
              ...
              $("#exampleModal").addClass("md:hidden");
